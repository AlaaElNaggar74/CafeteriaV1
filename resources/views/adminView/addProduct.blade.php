         ...
         <div class="Productfor col-md-9 col-lg-6 col-10 m-auto" >
            <form action="" >
                ...
                <div class="mb-1">
                    ...
                    <input type="number" class="form-control" id="pric" name="price" placeholder="Product Pr">
                  </div>
                {{-- <div class="mb-1">
                ...
                <div class="mb-1">
                    ...
                    <input type="file" class="form-control" id="proImag" name="image" placeholder="Product Image">
                  </div>
